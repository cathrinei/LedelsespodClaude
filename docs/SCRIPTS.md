...
- `SYSTEM_PROMPT` inneholder eksplisitte språkkrav: korrekt bokmål, unngå anglisismer («tangentielt» → «perifert berørt», «hovemotiv» → «hovedmotiv»); tre kategorietagger: `teamledelse`, `personalledelse`, `produktledelse`
